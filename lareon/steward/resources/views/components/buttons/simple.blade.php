  ...
  $sizes = [
    ...
    $colors = [
        'blue' => [
            ...
            'outline' => 'border border-blue-600 text-blue-600 hover:bg-blue-50 active:bg-blue-100 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2',
            'simple' => 'text-blue-600 hover:bg-blue-50 active:bg-blue-100',
        ],
        'gray' => [
            ...
            'outline' => 'border border-gray-600 text-gray-600 hover:bg-gray-50 active:bg-gray-100 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2',
            'simple' => 'text-gray-600 hover:bg-gray-50 active:bg-gray-100',
        ],
        'green' => [
            ...
            'outline' => 'border border-green-600 text-green-600 hover:bg-green-50 active:bg-green-100 focus:ring-2 focus:ring-green-500 focus:ring-offset-2',
            'simple' => 'text-green-600 hover:bg-green-50 active:bg-green-100',
        ],
        'red' => [
            ...
            'outline' => 'border border-red-600 text-red-600 hover:bg-red-50 active:bg-red-100 focus:ring-2 focus:ring-red-500 focus:ring-offset-2',
            'simple' => 'text-red-600 hover:bg-red-50 active:bg-red-100',
        ],
        'yellow' => [
            ...
            'outline' => 'border border-yellow-600 text-yellow-600 hover:bg-yellow-50 active:bg-yellow-100 focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2',
            'simple' => 'text-yellow-600 hover:bg-yellow-50 active:bg-yellow-100',
        ],
        'cyan' => [
            ...
            'outline' => 'border border-cyan-600 text-cyan-600 hover:bg-cyan-50 active:bg-cyan-100 focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2',
            'simple' => 'text-cyan-600 hover:bg-cyan-50 active:bg-cyan-100',
        ],
        'teal' => [
            ...
            'outline' => 'border border-teal-600 text-teal-600 hover:bg-teal-50 active:bg-teal-100 focus:ring-2 focus:ring-teal-500 focus:ring-offset-2',
            'simple' => 'text-teal-600 hover:bg-teal-50 active:bg-teal-100',
        ],
        'black' => [
            ...
            'outline' => 'border border-gray-900 text-gray-900 hover:bg-gray-50 active:bg-gray-100 focus:ring-2 focus:ring-gray-700 focus:ring-offset-2',
            'simple' => 'text-gray-900 hover:bg-gray-50 active:bg-gray-100',
        ],
    ];
