...
<div class="p-1">
    <a href="{{$href}}" class="hover:bg-slate-100 flex items-center gap-1 flex-col w-full bordering p-1 rounded-lg mx-auto {{$active ? 'bg-second_color_light text-second_color_dark' : ''}}">
