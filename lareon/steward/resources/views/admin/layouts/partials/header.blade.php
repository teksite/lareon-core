<header class="mb-6 w-full rounded-lg bg-theme-4 bg-cover bg-no-repeat bg-fixed">
    <div class="bg-linear-to-r from-cyan-500 to-blue-500 50 w-full h-full relative rounded-xl">
        ...
        @if(View::hasSection('header.start') || View::hasSection('header.end') )
            <div class="absolute x-box flex flex-col sm:flex-row items-center justify-between gap-6 -translate-y-12 inset-x-0 w-11/12 mx-auto">
