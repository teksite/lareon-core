import {loader} from "./general.js";

export function singleArrayInput() {
...
export function requestSendOTP() {
...
export function startOtpCooldown(button, originalHtml, seconds = 120) {
