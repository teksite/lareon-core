...
@section('title', __('lareon::global.crud.titles.edit',['attribute'=>__('profile')]) . "($user->fullname)")
    ...
    @section('form')
        <x-lareon::box type="y" class="space-y-3">
            <x-lareon::editor.input-password :label="__('current password')" name="current_password" :showConfirm="false" :strength="false" :placeholder="__('**********')" wrapperClass="grid gap-6 lg:grid-cols-2"/>
