<x-lareon::admin-editor type="update" method="patch" :instance="$permission" :action="route('admin.authorize.permissions.update', $permission)" :publishInfo="false" :publishData="false">
