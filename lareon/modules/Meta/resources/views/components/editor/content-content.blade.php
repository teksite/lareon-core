                            ...
                            <div class="my-3 flex justify-between items-center gap-6">
                                <div class="grid gap-3 md:grid-cols-2 w-full">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <x-lareon::inputs.text  x-bind:id="`dynamic_new_item_image-${index + lngth + 1}`" class="block w-full" x-model="field.txt2" x-bind:name="`{{$name}}[items][${index + lngth + 1}][image]`" dir="ltr"/>
                                    </div>
                                </div>
