...
//                'template'  => ['required', 'string', Rule::unique('meta_templates', 'template')->ignore($id)],
    ...
    {
        return $this->belongsToMany(MetaElement::class, 'templates_elements', 'template_id', 'element_id')->using(MetaElementTemplate::class)->withPivot(['name', 'title', 'settings', 'sort'])->orderByPivot('sort');
    }
