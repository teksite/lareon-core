...
<fieldset class="fieldset">
    ...
    <div class="space-y-6">
        ...
        <x-lareon::editor.input-textarea :label="__('description')" name="{{$finalName}}[description]" labelPosition="start" :required="$required" :placeholder="__('lareon::global.placeholders.empty.read',['attribute'=>__('meta')])">{{$value['article']['description'] ?? null}}</x-lareon::editor.input-textarea>
        <x-seo::editor.partials.image :name="$finalName" :value="$value['article']['image']?? []"/>
