@props(['value'=>[] ,'name'=>'seo', 'arrayName'=>'localBusiness'])
@php
...
<div class="grid gap-6 lg:grid-cols-2">
    <div class="space-y-6">
        ...
        <x-lareon::editor.input-textarea labelPosition="start" :label="__('description')" name="{{$finalName}}[localBusiness][description]" :placeholder="__('lareon::global.placeholders.empty.read',['attribute'=>__('website')])">{{$value['localBusiness']['description'] ?? null}}</x-lareon::editor.input-textarea>
