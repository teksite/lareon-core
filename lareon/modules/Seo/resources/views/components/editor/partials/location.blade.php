...
<fieldset class="fieldset">
    ...
    <div class="mb-3 grid gap-3 md:grid-cols-2">
        ...
        {{--City--}}
        <div class="">
            <x-lareon::editor.input labelPosition="start" :label="__('city')" name="{{$name}}[location][city]" :value="$location['country'] ?? null" :placeholder="__('lareon::global.placeholders.empty.read',['attribute'=>__('website')])"/>
