...
<fieldset class="fieldset">
    ...
    <div class="grid gap-6 md:grid-cols-2">
        ...
        <x-lareon::editor.input type="number" min="0" max="5" step="0.1" :label="__('worse rating')" name="{{$finalName}}[worstRating]" :value="$value['worstRating'] ?? null" labelPosition="top" dir="ltr" :required="false"/>
    </div>
</fieldset>
