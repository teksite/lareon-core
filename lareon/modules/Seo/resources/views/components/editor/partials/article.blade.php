...
<fieldset class="fieldset">
    ...
    <div class="space-y-6">
        <x-lareon::editor.input-select labelPosition="top" :label="__('type')" name="{{$finalName}}[type]" :value="$value['type'] ?? null" :required="$required">
        ...
        <x-lareon::editor.input :label="__('headline')" name="{{$finalName}}[headline]" :value="$value['headline'] ?? null" labelPosition="top" :required="$required" :placeholder="__('lareon::global.placeholders.write.two',['attribute'=>__('headline') ,'item'=>__('article')])"/>
