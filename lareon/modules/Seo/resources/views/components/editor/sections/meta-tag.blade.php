...
<section>
    <div class="bg-slate-50 p-6 bordering rounded-lg space-y-6">
        ...
        <div class="">
            <x-lareon::editor.input :required="true" labelPosition="start" :label="__('title')" name="seo[meta][title]" :value="$data['title'] ?? null" :placeholder="__('lareon::global.placeholders.write.two',['attribute'=>__('title') , 'item'=>__('meta')])"/>
            <x-lareon::editor.input-counter min="50" max="60" name="seo[meta][title]"/>
        </div>
        <div>
            <x-lareon::editor.input-textarea :required="true" labelPosition="start" :label="__('description')" name="seo[meta][description]" :value="$data['description'] ?? null" :placeholder="__('lareon::global.placeholders.write.two',['attribute'=>__('description') , 'item'=>__('meta')])"/>
