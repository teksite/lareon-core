    ...
    @section('form')
        ...
        <x-lareon::editor.tabs.item :title="__('website')">
            <x-lareon::editor.tabs.section>
                ...
                <x-seo::editor.sections.web-website :value="$website->value ?? []"/>
            </x-lareon::editor.tabs.section>
        </x-lareon::editor.tabs.section>
        ...
        <x-lareon::editor.tabs.item :title="__('local business')">
            <x-lareon::editor.tabs.section>
                ...
                <x-seo::editor.sections.web-localBusiness :value="$localBusiness->value ?? []" />
            </x-lareon::editor.tabs.section>
        </x-lareon::editor.tabs.section>
        ...
        <x-lareon::editor.tabs.item :title="__('organization')">
            <x-lareon::editor.tabs.section>
                ...
                <x-seo::editor.sections.web-organization :value="$organization->value ?? []" />
            </x-lareon::editor.tabs.section>
        </x-lareon::editor.tabs.section>
    @endsection
