<x-lareon::admin-editor :action="route('admin.pages.update' , $page)" :hasTab="false" :instance="$page">
    ...
    @section('aside')
        ...
        <x-lareon::editor.input-image :required="false" wrapperMode="y-box" :value="old('banner', $page->banner)" name="banner"/>
